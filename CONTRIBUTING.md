...
-   run benchmark: `docker run -it --rm -v $PWD:/app -v $PWD/misc/opcache.ini:/usr/local/etc/php/conf.d/docker-php-ext-opcache.ini -w /app chialab/php-dev:8.4 composer benchmark`
